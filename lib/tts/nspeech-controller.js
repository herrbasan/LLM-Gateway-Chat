...
export class NSpeechController {
    ...
    async init() {
        ...
        // 'llm' from older prefs degrades to client-side regex clean.
    ...
    _wireEvents() {
        ...
        // Markdown cleanup checkbox (off / true — client-side regex clean)
    ...
    // ============================================
    // Markdown cleanup (off / true — client-side regex)
    // ============================================
