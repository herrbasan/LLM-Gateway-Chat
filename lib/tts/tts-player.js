...
// ============================================
// Close (X) HARD-STOPS generation + playback (this.close()), not just hides
// the chrome. Kept-audio-after-close was the old behavior; a closed player
// must not keep burning the upstream TTS stream in the background.
